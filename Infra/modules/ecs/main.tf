...
resource "aws_security_group" "backend_alb" {
  name_prefix = "${local.name_prefix}-backend-alb-"
...
resource "aws_security_group" "backend_service" {
  name_prefix = "${local.name_prefix}-backend-service-"
  ...
  tags = {
    Name = "${local.name_prefix}-backend-service-sg"
  }
      ...
      secrets = [
        {
          ...
          valueFrom = "${var.secrets_arn}:opensearch_username::"
        },
        {
          name      = "OPENSEARCH_PASSWORD"
          valueFrom = "${var.secrets_arn}:opensearch_password::"
        }
      ]
...
resource "aws_ecs_service" "backend" {
  ...
  depends_on = [
    ...
    aws_iam_role_policy.backend_bedrock_access
  ]
...
resource "aws_security_group" "frontend_alb" {
  name_prefix = "${local.name_prefix}-frontend-alb-"
...
resource "aws_security_group" "frontend_service" {
  name_prefix = "${local.name_prefix}-frontend-service-"
  ...
  tags = {
    Name = "${local.name_prefix}-frontend-service-sg"
  }
